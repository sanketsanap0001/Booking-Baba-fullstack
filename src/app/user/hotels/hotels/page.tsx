...
import { ArrowLeftIcon, ArrowRightIcon, MapPinIcon } from "@heroicons/react/24/solid";
import { Accordion, AccordionBody, AccordionHeader, Checkbox, IconButton, checkbox } from "@material-tailwind/react";
...
export default function UserHotelPage() {
  ...
  const hotelDataList: any = useSelector((state: any) => state.hotel.hotelDetails);
...
setHotelData(filterHotel)
 ...
 <div className="mt-4 font-Signika">
